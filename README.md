...
В файле phones/config.py необходимо указать данные для подключения к БД (хост, порт, логин, пароль). Пример содержимого данного файла представлен в phones/config_example.py. Эти данные будут использованы в настройках Django (main/settings.py)
